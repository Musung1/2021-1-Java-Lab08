...
/**
 * include main function which use converters
 */

public class IntegratedConverter { // include main function which use converters

    private double fromValue;
    /**
     * run myconverter.run(arg)
     * @param args arg[0] = fromvalue, arg[1] = originalMeasure, arg[2] = targetMeasure
     */
